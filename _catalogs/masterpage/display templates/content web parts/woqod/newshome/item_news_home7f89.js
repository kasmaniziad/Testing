...
function DisplayTemplate_f4798e6bbf54464c866ea3f1b69c9642(ctx) {
  var ms_outHtml=[];
  var cachePreviousTemplateData = ctx['DisplayTemplateData'];
  ctx['DisplayTemplateData'] = new Object();
  DisplayTemplate_f4798e6bbf54464c866ea3f1b69c9642.DisplayTemplateData = ctx['DisplayTemplateData'];

  ctx['DisplayTemplateData']['TemplateUrl']='~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContent Web Parts\u002fWOQOD\u002fNewsHome\u002fItem_News_Home.js';
  ctx['DisplayTemplateData']['TemplateType']='Item';
  ctx['DisplayTemplateData']['TargetControlType']=['Content Web Parts'];
  this.DisplayTemplateData = ctx['DisplayTemplateData'];

  ctx['DisplayTemplateData']['ManagedPropertyMapping']={'xTitle':['Title', 'xPortalTitleOWSTEXT'], 'Link URL':['Path'], 'xMainImage':['xPortalMainImageOWSIMGE'], 'xMainImageCaption':['xPortalMainImageCaptionOWSMTXT'], 'xImage01':['xPortalImage01OWSIMGE'], 'xImageCaption01':['xPortalImage01CaptionOWSMTXT'], 'xImage02':['xPortalImage02OWSIMGE'], 'xImageCaption02':['xPortalImage02CaptionOWSMTXT'], 'xVideo':['xPortalVideoURLOWSURLH'], 'xVideoCaption':['xPortalVideoCaptionOWSMTXT'], 'xContent':['xPortalContentOWSHTML'], 'xSummary':['xPortalSummaryOWSTEXT'], 'NewsCategory':['xPortalNewsLookUp'], 'xFeatured':['xPortalShowOWSBOOL'], 'xDate':['xPortalDate'], 'xStartDate':['xPortalStartDate'], 'xEndDate':['xPortalEndDate'], 'xMap':['xPortalMapOWSTEXT'], 'xPhone':['xPortalPhoneOWSTEXT'], 'xFax':['xPortalFaxOWSTEXT'], 'xMail':['xPortalEmailOWSTEXT'], 'xCountry':['xPortalCountryOWSCHCS'], 'xAddress':['xPortalAddressOWSMTXT'], 'AlbumID':['ListItemID'], 'SecondaryFileExtension':null, 'ContentTypeId':null};
...
if(!xTitle.isEmpty){
ms_outHtml.push(''
,'<div class="dotdotdot homeNewsTitleCont">'
,'		<a class="subTitle font18 block uppercase" href="', linkURL ,'" title="', linkURL ,'">', xTitle ,'</a>'
,'		</div>'
);
}
ms_outHtml.push(''
...
function RegisterTemplate_f4798e6bbf54464c866ea3f1b69c9642() {

if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
  Srch.U.registerRenderTemplateByName("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContent Web Parts\u002fWOQOD\u002fNewsHome\u002fItem_News_Home.js", DisplayTemplate_f4798e6bbf54464c866ea3f1b69c9642);
}
//
	$includeLanguageScript("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContent Web Parts\u002fWOQOD\u002fNewsHome\u002fItem_News_Home.js", "~sitecollection/_layouts/15/ITWorx.WOQOD.Careers/moment-with-locales.js");
//
}
RegisterTemplate_f4798e6bbf54464c866ea3f1b69c9642();
if (typeof(RegisterModuleInit) == "function" && typeof(Srch.U.replaceUrlTokens) == "function") {
  RegisterModuleInit(Srch.U.replaceUrlTokens("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContent Web Parts\u002fWOQOD\u002fNewsHome\u002fItem_News_Home.js"), RegisterTemplate_f4798e6bbf54464c866ea3f1b69c9642);
}